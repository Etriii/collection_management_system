...
import { ArrowLeftRight, FileText, History, LayoutDashboard, LayoutGrid, UserRoundCog, UsersRound } from 'lucide-vue-next';
...
<template>
    <aside 
        class="fixed left-0 inset-y-0 z-30 transition-all duration-300 shadow-lg"
